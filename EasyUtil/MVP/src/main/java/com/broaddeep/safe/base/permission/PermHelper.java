...
public class PermHelper {
            ...
            AlertDialog dialog = new AlertDialog.Builder(activity)
                    ...
                    .setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (object instanceof PermCallback) {
                                ((PermCallback) object).onPermissionDenied(requestCode, Arrays.asList(perms));
                            }
                        }
                    }).create();
            dialog.show();
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (!granted.isEmpty() && denied.isEmpty()) {
            if (object instanceof PermCallback)
                ((PermCallback) object).onPermissionAllGranted();
        } else if (!granted.isEmpty()) {
            if (object instanceof PermCallback) {
                ((PermCallback) object).onPermissionGranted(requestCode, granted);
            }
        } else if (!denied.isEmpty()) {
            if (object instanceof PermCallback) {
                ((PermCallback) object).onPermissionDenied(requestCode, denied);
            }
        }
    }
}
